...
public class HotelServiceImpl implements HotelService {
    ...
    @Override
    public void setNewRate(Integer hotelId, double avg) {
        hotelMapper.setNewRate(hotelId, avg);
    }
    ...
    @Override
    public List<HotelVO> getHotelByManagerId(Integer id){
        return hotelMapper.selectHotelByManagerId(id);
    }
}
