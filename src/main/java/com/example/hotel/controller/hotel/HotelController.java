...
public class HotelController {
    ...
    public ResponseVO createHotel(@RequestBody HotelVO hotelVO) throws ServiceException {
        System.out.println("begin add hotel");
    ...
    @GetMapping("/{id}/getHotelByManagerId")
    public ResponseVO getHotelByManagerId(@PathVariable Integer id){
        return ResponseVO.buildSuccess(hotelService.getHotelByManagerId(id));
    }
